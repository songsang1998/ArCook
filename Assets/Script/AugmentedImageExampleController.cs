              ...
              //  m_Visualizers.TryGetValue(image.DatabaseIndex, out visualizer);
                if (image.TrackingState == TrackingState.Tracking)
                {
                    if (image.Name == "Apple")
                    {
                        ...
                        SceneManager.LoadScene("사과");
                    }

                    else if (image.Name == "wheat")
                    {

                        SceneManager.LoadScene("밀가루");
                    }

                    else if (image.Name == "ice")
                    {

                        SceneManager.LoadScene("얼음");
                    }
                    else if (image.Name == "checkin")
                    {

                        SceneManager.LoadScene("닭");
                    }
                    else if (image.Name == "milk")
                    {

                        SceneManager.LoadScene("우유");
                    }
                    else if (image.Name == "potato")
                    {

                        SceneManager.LoadScene("감자");
                    }
                    else if (image.Name == "egg")
                    {

                        SceneManager.LoadScene("계란");
                    }
                    else if (image.Name == "rice")
                    {

                        SceneManager.LoadScene("쌀");
                    }
